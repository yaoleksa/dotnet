...
namespace APIGetsSFData.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public async Task Get()
        {
            ...
            sessionManager.BeginSession("C:\\Quickbooks FIles\\1white horse capital, llc permanent 2012.qbw", ENOpenMode.omDontCare);
            ...
            foreach (purchaseOrderRecord po in displayResp)
            {
                ...
                if(po.All_outbound_wires_inserted__c)
                {
                    string sfPoN = Regex.Match(po.Name, "[0-9]+").Value;
