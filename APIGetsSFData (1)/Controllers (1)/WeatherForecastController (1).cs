...
namespace APIGetsSFData.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public async Task Get()
        {
            ...
            GetBillQB.BuildBillQuery(queryBill, DateTime.Today.AddDays(-6));
            ...
            /// (.)(.)(.)(.)(.)(.)(.)(.)(.)(.)(.)(.)(.)
            /// QueryCheck
            IMsgSetRequest queryCheck = sessionManager.CreateMsgSetRequest("US", 15, 0);
            ...
            foreach (purchaseOrderRecord po in displayResp)
            {
                ...
                string withZeros = Regex.Match(po.Name, "[0-9]+", 
                    RegexOptions.IgnoreCase).Value;
                string poNum = Regex.Replace(withZeros, "^[0]+", "");
                ...
                thisVendorNumber = Regex.Match(po.Vendor_Order__c, "[0-9]+", 
                    RegexOptions.IgnoreCase).Value;
                    ...
                    exMems.Contains(extendedWireName)))
                {
                    ...
                    {
                        res += "Existing check: " + thisVendorNumber + '\n';
                    }
                }
                    ...
                    !exBills.ContainsKey(thisVendorNumber))
                {
                        ...
                        List<string>> kvp in vendorNames)
                    {
                        ...
                        } else
                        {
                            ...
                            {
                                string billNo = Regex.Match(po.IRA_Account__c,
                                    "[0-9]+", RegexOptions.IgnoreCase).Value;
                                if (exBills.ContainsKey(billNo))
                                {
                ...
                if (exBills.ContainsKey(thisVendorNumber))
                {
